...
public abstract class AbstractListNode<E> extends AbstractNode implements ListNode<E> {
    ...
    private ToIntFunction<E> itemHeightFunction;
    ...
    @Override
    public int getItemHeight(E item) {
        return itemHeightFunction == null ? getItemHeight() : itemHeightFunction.applyAsInt(item);
    }

    @Override
    public void setItemHeightFunction(ToIntFunction<E> function) {
        this.itemHeightFunction = function;
        shouldComputeSize();
        resetSkin();
    }
