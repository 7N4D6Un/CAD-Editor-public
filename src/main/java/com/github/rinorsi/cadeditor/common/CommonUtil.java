...
public class CommonUtil {
    ...
    public static void showVaultItemGivePartial(Player player, int count) {
        showMessage(player, ModTexts.Messages.vaultItemGivePartial(count));
    }

    public static void showVaultItemGiveFull(Player player) {
        showMessage(player, ModTexts.Messages.VAULT_ITEM_GIVE_FULL);
    }
}
