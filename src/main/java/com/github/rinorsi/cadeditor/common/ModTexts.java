...
public final class ModTexts {
    ...
    public static final MutableComponent BLUE = GuapiHelper.translated("cadeditor.gui.color_blue").withStyle(ChatFormatting.BLUE);
    ...
    public static final MutableComponent GREEN = GuapiHelper.translated("cadeditor.gui.color_green").withStyle(ChatFormatting.GREEN);
    ...
    public static final MutableComponent RED = GuapiHelper.translated("cadeditor.gui.color_red").withStyle(ChatFormatting.RED);
    ...
    public static final MutableComponent TEXT_FORMAT_HEAD = GuapiHelper.translated("cadeditor.gui.text_format.head");
    public static final MutableComponent TEXT_FORMAT_SPRITE = GuapiHelper.translated("cadeditor.gui.text_format.sprite");
    public static final MutableComponent TEXT_FORMAT_TRANSLATION = GuapiHelper.translated("cadeditor.gui.text_format.translation");
    public static final MutableComponent TEXT_FORMAT_FONT = GuapiHelper.translated("cadeditor.gui.text_format.font");
    public static final MutableComponent TEXT_FORMAT_GRADIENT = GuapiHelper.translated("cadeditor.gui.text_format.gradient");
    public static final MutableComponent TEXT_FORMAT_HEAD_TITLE = GuapiHelper.translated("cadeditor.gui.text_format.head_title");
    public static final MutableComponent TEXT_FORMAT_SPRITE_TITLE = GuapiHelper.translated("cadeditor.gui.text_format.sprite_title");
    ...
    public static final MutableComponent DIALOG_FILL_OWN_DATA = GuapiHelper.translated("cadeditor.gui.fill_own_data");
    public static final MutableComponent DIALOG_TEXTURE_VALUE = GuapiHelper.translated("cadeditor.gui.profile_texture_value");
    public static final MutableComponent DIALOG_TEXTURE_SIGNATURE = GuapiHelper.translated("cadeditor.gui.profile_texture_signature");
    public static final MutableComponent DIALOG_INCLUDE_HAT = GuapiHelper.translated("cadeditor.gui.text_format.dialog.include_hat");
    public static final MutableComponent DIALOG_ATLAS_ID = GuapiHelper.translated("cadeditor.gui.text_format.dialog.atlas_id");
    public static final MutableComponent DIALOG_SPRITE_ID = GuapiHelper.translated("cadeditor.gui.text_format.dialog.sprite_id");
    public static final MutableComponent DIALOG_TRANSLATION_KEY = GuapiHelper.translated("cadeditor.gui.text_format.dialog.translation_key");
    public static final MutableComponent DIALOG_FALLBACK_TEXT = GuapiHelper.translated("cadeditor.gui.text_format.dialog.fallback_text");
    public static final MutableComponent DIALOG_GRADIENT_START = GuapiHelper.translated("cadeditor.gui.text_format.dialog.gradient_start");
