...
public class StringWithActionsEntryModel extends ValueEntryModel<String> {
    ...
    public record ActionButton(Identifier icon, Component text, MutableComponent tooltip, Runnable action) {
        public ActionButton(Identifier icon, MutableComponent tooltip, Runnable action) {
            this(icon, null, tooltip, action);
        }

        public ActionButton(Component text, MutableComponent tooltip, Runnable action) {
            this(null, text, tooltip, action);
        }
    }
}
