...
public class TrimMaterialSelectionEntryModel extends SelectionEntryModel {
    public TrimMaterialSelectionEntryModel(CategoryModel category, String value, Consumer<String> action) {
        super(category, ModTexts.TRIM_MATERIAL, value, action);
    }
    ...
    public MutableComponent getSelectionScreenTitle() {
        return ModTexts.TRIM_MATERIAL;
    }

    @Override
    public List<? extends ListSelectionElementModel> getSelectionItems() {
        return ClientCache.getTrimMaterialSelectionItems();
    }
}
