...
public class AttributeModifierEntryView extends EntryView {
    ...
    private Button infinityAmountButton;
    private Button negativeInfinityAmountButton;
    ...
    protected Node createContent() {
        return vBox(content -> {
            content.add(hBox(top -> {
                ...
                top.add(attributePreviewLabel = label().prefHeight(16).visible(false));
            ...
            content.add(hBox(bottom -> {
                ...
                bottom.add(infinityAmountButton = button("∞").prefWidth(16).prefHeight(16)
                        .tooltip(ModTexts.gui("attribute_set_infinity")));
                bottom.add(negativeInfinityAmountButton = button("-∞").prefWidth(16).prefHeight(16)
                        .tooltip(ModTexts.gui("attribute_set_negative_infinity")));
    ...
    public Button getInfinityAmountButton() {
        return infinityAmountButton;
    }

    public Button getNegativeInfinityAmountButton() {
        return negativeInfinityAmountButton;
    }

    public Label getAttributePreviewLabel() {
        return attributePreviewLabel;
    }
}
