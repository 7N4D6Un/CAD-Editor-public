...
public class EntityVillagerDataCategoryModel extends EntityCategoryModel {
    ...
    private String professionId = NONE_PROFESSION;
    private String initialProfessionId = NONE_PROFESSION;
    ...
    protected void setupEntries() {
        ...
        professionId = normalizeId(villagerData.getString("profession").orElse(null), NONE_PROFESSION);
        ...
        getEntries().add(new VillagerProfessionSelectionEntryModel(this, ModTexts.VILLAGER_PROFESSION, professionId,
                value -> professionId = normalizeId(value, NONE_PROFESSION)));
    ...
    private void writeVillagerData() {
        ...
        if (professionChanged && !NONE_PROFESSION.equals(profession) && villagerLevel < MIN_STABLE_PROFESSION_LEVEL) {
