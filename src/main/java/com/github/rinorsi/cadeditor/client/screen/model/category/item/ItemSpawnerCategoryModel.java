...
public class ItemSpawnerCategoryModel extends ItemEditorCategoryModel {
    ...
    public void apply() {
        ...
        CompoundTag tag = workingTag.copy();
        ...
        CompoundTag entity = sanitizeEntityData(entityEntry == null ? new CompoundTag() : entityEntry.copyValue());
        ...
        payload.remove("id");
        BlockEntityType<?> type = BlockEntityTypes.MOB_SPAWNER;
        stack.set(DataComponents.BLOCK_ENTITY_DATA, TypedEntityData.of(type, payload));
