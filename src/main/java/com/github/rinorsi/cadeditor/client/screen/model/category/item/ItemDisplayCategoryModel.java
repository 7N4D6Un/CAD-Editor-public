...
public class ItemDisplayCategoryModel extends ItemEditorCategoryModel {
    ...
    protected void setupEntries() {
        itemNameEntry = new TextEntryModel(this, ModTexts.ITEM_NAME, getItemNameOverride(), value -> {});
        customNameEntry = new TextEntryModel(this, ModTexts.CUSTOM_NAME, getCustomName(), value -> {});
    ...
    @Override
    public void apply() {
        boolean nameChanged = itemNameEntry.valueChangedProperty().getValue();
        boolean customNameChanged = customNameEntry.valueChangedProperty().getValue();
        super.apply();
        if (nameChanged) {
