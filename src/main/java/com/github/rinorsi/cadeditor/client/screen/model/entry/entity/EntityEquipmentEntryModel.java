...
public class EntityEquipmentEntryModel extends EntryModel {
    ...
    public void setDropChance(float chance) {
        ...
        float clamped = Math.max(0f, Math.min(EntityEquipmentCategoryModel.MAX_DROP_CHANCE, safeChance));
    ...
    public boolean isDropChanceTextValid(String text) {
        ...
        try {
            ...
            return Float.isFinite(value) && value >= 0f && value <= EntityEquipmentCategoryModel.MAX_DROP_CHANCE;
    ...
    private void invalidateIfNecessary() {
        Float value = dropChanceProperty.getValue();
        boolean valid = value != null && Float.isFinite(value) && value >= 0f && value <= EntityEquipmentCategoryModel.MAX_DROP_CHANCE;
        setValid(valid);
    }
